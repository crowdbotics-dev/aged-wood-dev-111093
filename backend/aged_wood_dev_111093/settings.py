"""
Django settings for aged_wood_dev_111093 project.
...
ROOT_URLCONF = 'aged_wood_dev_111093.urls'
...
WSGI_APPLICATION = 'aged_wood_dev_111093.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_wood_dev_111093 API",
    "DESCRIPTION": "API documentation for aged_wood_dev_111093 App",
    "VERSION": "v1",
}
